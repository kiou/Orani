...
namespace ReferencementBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="ReferencementBundle\Repository\ReferencementRepository")
...
class Referencement
{
    ...
    {
        return __DIR__.'/../../../web/img/referencement/';
    }
}
